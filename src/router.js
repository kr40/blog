...
export function handleRouteChange() {
    ...
    if (postMatch && postMatch[1]) {
        ...
        renderPostList(filteredPosts, contentAreaElement, `Showing: ${title}`);
        ...
        renderPostList(filteredPosts, contentAreaElement, `Category: ${categoryName || categorySlug}`);
        ...
        renderPostList(filteredPosts, contentAreaElement, `Tag: #${tagName || tagSlug}`);
        ...
        renderPostList(filteredPosts, contentAreaElement, `Author: ${authorName || authorSlug}`);
    } else if (hash === '#/about') {
        // About Page
